  ...
  <body>
   ...
   <div class="container d-grid sign-con">
        <div class="form-container">
            <form action="../php/signin.php" method="post" class="d-flex flex-column s-form">
                ...
                <button class="btn btn-success mt-3" name="signin">Sign in</button>
                <label for="">Don't have an account yet? <a href="signup.php">Sign up</a></label>
            </form>
        </div>
   </div>
  </body>
